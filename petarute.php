...
//Menampilkan peta pada div canvas yang disediakan
		...
		//var chicago = new google.maps.LatLng(-1.48518, 102.43806);
		var start = new google.maps.LatLng(-1.48518, 102.43806);
		var end = new google.maps.LatLng(-1.38518, 100.43806);
		var request = {
			origin:start,
			destination:end,
